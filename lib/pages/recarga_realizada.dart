...
class RecargaRealizada extends StatefulWidget {
  @override
  _RecargaRealizada createState() => _RecargaRealizada();
}

class _RecargaRealizada extends State<RecargaRealizada> {
  @override
  void initState() {
        ...
        body: Column(
          children: [
            ...
            Row(
              ...
              children: [
                Image(
                  image: AssetImage('assets/images/recargarealizada.png'),
                ),
              ],
            ),
            SizedBox(
            ...
            Row(
              ...
              children: [
                Text(
                  'para ',
                  style: CustomTextStyles.inter16pretoclaro500,
                ),
                Text('(47) 99902-3880',
              ...
              children: [
                Observer(builder: (_) {
                  return GestureDetector(
                    onTap: () {
                      Navigator.of(context).pushNamed('/recargacomprovante');
                    },
                    child: Container(
                      height: 54,
