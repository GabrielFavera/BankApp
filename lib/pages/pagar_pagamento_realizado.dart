...
class PagamentoRealizado extends StatefulWidget {
  @override
  _PagamentoRealizado createState() => _PagamentoRealizado();
}

class _PagamentoRealizado extends State<PagamentoRealizado> {
 @override
  void initState() {
        ...
        body: Column(
          children: [
            ...
            Row(
              ...
              children: [
                Image(
                  image: AssetImage('assets/images/pagarrealizado.png'),
                ),
              ],
            ),
            SizedBox(
              ...
              children: [
                Observer(builder: (_) {
                  return GestureDetector(
                    onTap: () {
                      Navigator.of(context).pushNamed('/pagarcomprovante');
                    },
                    child: Container(
                      height: 54,
