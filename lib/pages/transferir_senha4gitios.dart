...
class Senha4Digitos extends StatefulWidget {
  @override
  _Senha4Digitos createState() => _Senha4Digitos();
}

class _Senha4Digitos extends State<Senha4Digitos> {
   @override
  void initState() {
  ...
  Senha4DigitosStore senha4DigitosStore = Senha4DigitosStore();
          ...
          children: [
                  ...
                  builder: (_) {
                    return Container(
                      ...
                      child: PinInputTextField(
                        pinLength: 4,
                        onChanged: senha4DigitosStore.setSenha4Digitos,
            ...
            Observer(builder: (_) {
              return Row(
                ...
                children: [
                  GestureDetector(
                    onTap: senha4DigitosStore.isSenha4DigitosValid
                        ? () {
                            senha4DigitosStore.carregando2(
                              context: context,
                            );
                          }
                        : () {
                    ...
                    child: Container(
                      ...
                      width: 54,
                      decoration: BoxDecoration(
                          color: senha4DigitosStore.isSenha4DigitosValid
